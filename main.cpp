...
int char_pos(string x,char c){
    int pos = 0;  /** pos is edited from NULLL to 0 **/
...
bool numExist(string x){
    bool res=false;
    if(char_exist(x,"1")||char_exist(x,"2")||char_exist(x,"3")||
       char_exist(x,"4")||char_exist(x,"5")||char_exist(x,"6")||
       char_exist(x,"7")||char_exist(x,"8")||char_exist(x,"9")||char_exist(x,"0")){
